...
router.get('/hostal', availabilityLimiter, ctrl.hostal);
...
router.post('/reservations',
  ...
  [
    ...
    // Ley 29733: sin consentimiento expreso no se guardan datos personales.
    body('acepta_privacidad').custom(v => v === true)
      .withMessage('Para enviar tu solicitud debes aceptar la Política de privacidad.'),
  ],
  validate,
